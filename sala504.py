...
def handle_callback_query(call):
    if call.data == 'sim':
        ...
        bot.send_message(call.message.chat.id,texto2)
        markup = types.InlineKeyboardMarkup()
        ...
        bot.send_message(call.message.chat.id,texto3)
        markup = types.InlineKeyboardMarkup()
...
def handle_callback_query(call):
    if call.data == 'sim':
        ...
        bot.send_message(call.message.chat.id,texto5)
        markup = types.InlineKeyboardMarkup()
        ...
        bot.send_message(call.message.chat.id,texto6)
        markup = types.InlineKeyboardMarkup()
