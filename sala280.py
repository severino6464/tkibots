...
🖥 Link de cadastro:[Clique aqui](https://18kbet.online/player-from-agent/agent/3m0x9)
"""
...
if ultimos_resultados != check_resultados:
    ...
    if x1 == x2:
        ...
        🎯[APOSTE AQUI](https://18kbet.online/player-from-agent/agent/3m0x9)
        🎁 [Clique aqui](https://18kbet.online/player-from-agent/agent/3m0x9)
"""
