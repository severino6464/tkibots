...
🖥 Link de cadastro:[Clique aqui](https://affiliates.nuts.bet/visit/?bta=36463&brand=nutsbet)
"""
...
if ultimos_resultados != check_resultados:
    ...
    if x1 == x2 == x3 == x4:
        ...
        🎯[APOSTE AQUI](https://affiliates.nuts.bet/visit/?bta=36463&brand=nutsbet)
