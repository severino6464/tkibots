...
🖥 Link de cadastro:[Clique aqui](https://18kbet.online/player-from-agent/agent/2kex9)
"""
...
📲: Plataforma correta: [Clique aqui](https://18kbet.online/player-from-agent/agent/2kex9)
"""

print("BOT-spaceman-marcos-18k")
